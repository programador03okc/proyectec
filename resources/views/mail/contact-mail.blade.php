                    ...
                    <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
                        <tr>
                            <td style="padding:0; background:#fff;text-align: center;" >
                                <img src="{{ asset('assets/img/PROYECTEC_LOGO.png') }}" alt="" width="" height="120px" style="text-align: center;" />
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0; background:#fff;">
                                    <tr>
                                        <td style="padding:0;text-align: center;">
                                            <h1>ESTAREMOS EN CONTACTO</h1>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td style="padding:0;text-align: center;">
                                            <P>CLICK PARA INGRESAR </P>
                                    ...
                                    <tr>
                                        <td style="padding:30px;text-align: center;">
                                            <a href="{{route("home")}}" style="padding: 15PX;background-color:#7EBA2F;border-radius: 23px;
                                            color: #ffff;
                                            text-decoration: none;">INGRESE AHORA</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
